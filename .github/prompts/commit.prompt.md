...
3. Generate a message: `<type>(<scope>): <description>` + body with bullet points summarizing key changes
4. Output in a code block for the user to copy

Always include a body unless the change is a single trivial file edit.
Types: feat, fix, docs, perf, refactor, test, chore, ci, revert
